...
export default [
  ...
  },
  {
    ...
    progress: ["hangapp"],
    guessedLetters: ["h", "a", "n", "g", "a", "p"],
    category: "",
    timestamp: 1584426311376,
    won: true,
    mode: "dictionary",
    categories: ["recipes"]
  }
