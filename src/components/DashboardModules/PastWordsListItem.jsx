  ...
  <div className="list-item">
    <div className="list-item__word-group">
      <h3 className="list-item__title">
        {props.word === 'hangapp' ? (
          <a className="link" href={'#'}>{props.word}</a>
        ) : (
          <a className="link" href={`https://www.merriam-webster.com/dictionary/${props.word}/`} target="_blank">{props.word}</a>
        )}
        <span className="list-item__subtitle list-item__subtitle--word-type">({props.type})</span>
      </h3>
